 ...
 * @author ivan
 */
public class Juego extends javax.swing.JFrame implements KeyEventDispatcher {
...
/*
        if (automaticoAux == true) {
            if (cuentaPartidas % 2 == 0) {
                Random rand = new Random();
                int numeroAleatorio = rand.nextInt(9);
                lbl[numeroAleatorio].setText(turno);
                otroTurno();
                automatico = true;
            }
        }
